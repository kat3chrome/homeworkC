...
3. Дан массив размером `n`, в нём есть нули, надо их все переместить в конец, при этом не создавая новый массив. [[Solution]](https://github.com/kat3chrome/homeworkC/blob/master/semester_1/hw_3/3.3.c)
...
[[Solution]](https://github.com/kat3chrome/homeworkC/blob/master/semester_1/hw_6/6.1.c)
```
Enter a number: -2.5
Result: -1.25*2^1
...
2. Ввести два числа, перевести в двоичное представление (в каком-либо из кодов) и в этом двоичном виде напечатать, сложить, вывести сумму в двоичном и десятичном виде (суммировать двоичные числа). [[Solution]](https://github.com/kat3chrome/homeworkC/blob/master/semester_1/hw_6/6.2.c)
